...
const ArticleAudit = () => import(/* webpackChunkName: 'Loadmore' */'../pages/tool/ArticleAudit.vue');
const ArticleDetail = () => import(/* webpackChunkName: 'Loadmore' */'../pages/tool/ArticleDetail.vue');
...
export default new Router({
  routes: [
    ...
    {
      path: '/tool/artileAudit', name: 'articleAudit', component: ArticleAudit
    },
    {
      path: '/tool/ArticleDetail', name: 'ArticleDetail', component: ArticleDetail
    },
    {
