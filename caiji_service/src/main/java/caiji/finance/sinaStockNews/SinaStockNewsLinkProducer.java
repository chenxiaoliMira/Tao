 ...
 */
@Controller
public class SinaStockNewsLinkProducer {

    private static final String URL = "http://finance.sina.com.cn/roll/index.d.html?cid=56592&page=1";

    private static final String FILTER_PATTERN = "https://finance.sina.com.cn/[\\S]+doc-[\\S]+shtml";
    ...
    public void runAGrab(){
        ...
        for (String url : urlList){
            ...
            TargetGrabLink targetGrabLink = (TargetGrabLink)TaoCache.appContext.getBean("sinaStockNewsTargetLink");
